...
<head>
  ...
  <link rel="stylesheet" href="/panneluser/styles-connexion.css">
</head>
...
<body>
  ...
  <main>
        ...
        <section class="user-panel">
            ...
            <div id="user-content">
                <!-- Contenu du panneau utilisateur (visible après la connexion) -->
            </div>
        </section>
      ...
      <div class="container-Juridique">
        <ul class="menu nav">
          ...
          <li class=""><span class="nolink" tabindex="0">Nos sites</span>
            <ul class="menu nav">
              <li class="first leaf menu-mlid-4060"><a href="http://projettennis/">Application IOS</a></li>
